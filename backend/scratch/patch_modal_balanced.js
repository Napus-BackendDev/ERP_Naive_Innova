...
// Replace the entire Add Machine Modal block with the new 50/50 balanced layout
...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  const newModalText = `{/* Add Machine Modal */}
      {isMachineModalOpen && (
        <div className="fixed inset-0 bg-black/60 z-55 flex items-center justify-center p-4 backdrop-blur-xs">
          <Card className="bg-white border border-slate-200 rounded-2xl w-full max-w-4xl p-6 shadow-2xl relative animate-in fade-in zoom-in-95 duration-200 select-none text-left max-h-[95vh] overflow-y-auto">
            <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
              ...
              {/* LEFT COLUMN: Machine Info (50% Width) */}
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="w-full flex justify-center py-2">
                    {newMachineImage ? (
                      ...
                      <label className="flex flex-col items-center justify-center gap-2 w-[200px] aspect-square bg-slate-50 hover:bg-slate-100/50 text-slate-650 rounded-2xl text-[10px] font-extrabold transition-all cursor-pointer border border-dashed border-slate-350 shadow-3xs active:scale-98">
              ...
              {/* RIGHT COLUMN: Allowed/Disallowed Formulas (50% Width) */}
              <div className="space-y-4">
                ...
                {/* Allowed Checkboxes Grid (2 Columns) */}
                <div className="space-y-1.5">
                ...
                {/* Disallowed Checkboxes Grid (2 Columns) */}
  ...
  console.log("Successfully replaced Old Modal JSX with 50/50 split and 2-column formulas grid!");
} else {
...
console.log("Successfully completed ProductionView.js balanced adjustments!");
